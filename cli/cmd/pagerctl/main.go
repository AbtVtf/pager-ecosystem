...
func main() {
	...
	case "publish":
		if err := runPublish(context.Background(), os.Args[2:], os.Stdin, os.Stdout, os.Stderr); err != nil {
	...
	case "simulate":
		if err := runSimulate(context.Background(), os.Args[2:], os.Stdout, os.Stderr); err != nil {
